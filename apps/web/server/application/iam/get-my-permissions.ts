...
import type { PermissionCode, ProjectRoleCode, SiteRoleCode } from "@/server/domains/iam/model";
...
export interface MyPermissions {
  ...
  projects: { permissions: PermissionCode[]; projectId: string; role: ProjectRoleCode }[];
}
